...
public class Exercicio1ComClasse {
    ...
    public static void main(String [] args) {
        ...
        System.out.printf("Área do triangulo X : %.4f%n ", x.area(x));
        System.out.printf("Área do triangulo Y : %.4f%n", y.area(y));
        if(x.area(x) > y.area(y)){
            System.out.printf("Área do triangulo X  : %.4f%n é maior ", x.area(x));
        }else{
            System.out.printf("Área do triangulo Y :  %.4f%n é maior ", y.area(y));
        }
